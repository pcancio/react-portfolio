            ...
            <Card style={{ width: "18rem" }}>
              ...
              <Card.Body>
                ...
                <Card.Text>
                  ...
                  about their pets, allergies, diets and more. Users can comment
                  on other posts and will receive notifications when other users
            ...
            <Card style={{ width: "18rem" }}>
              ...
              <Card.Body>
                ...
                <Card.Text>
                  ...
                  to log and track their withdrawals and deposits and keep their
                  balance accurate with or without a data or internet
                  connection.
                </Card.Text>
                <Card.Link
            ...
            <Card style={{ width: "18rem" }}>
              ...
              <Card.Body>
                ...
                <Card.Text>
                  ...
                  schedule their day. Each time block is color-coded to indicate
                  whether the event or meeting is in the past, present, or
                  future. The data is saved in local storage and persists even
          ...
          <div className="col-lg-4 py-2">
            <Card style={{ width: "18rem" }}>
              ...
              <Card.Body>
                ...
                <Card.Text>
                  This is an app that generates a random password. The app runs
                  in the browser and features dynamically updated HTML and CSS
                  powered by JavaScript code. It has a clean and polished user
                  interface and is responsive, which ensures that it adapts to
            ...
            <Card style={{ width: "18rem" }}>
              ...
              <Card.Body>
                ...
                <Card.Text>
                  ...
                  required to join the blog. Once signed up and logged in, users
                  can post, comment, and interace with other techies!
                </Card.Text>
                <Card.Link
