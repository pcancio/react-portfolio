          ...
          <div className="row m-auto">
            <div className="col-12 col-md-6 col-lg-4 m-2">
              <Card border="primary" style={{ width: "18rem" }}>
                ...
                <Card.Body>
                  <Card.Title>QRad</Card.Title>
                  <Card.Text>
                    This app eliminates the need for physical business cards by
                    assigning data to a QR code that can be shared into a
                    searchable database.
                  </Card.Text>
                  <Card.Link
                    href="https://github.com/hpurring/project-3-group-a"
                    target="_blank"
                  >
                    Deployed App
                  </Card.Link>
                  <Card.Link
                    href="https://salty-wave-44811.herokuapp.com/"
                    target="_blank"
                  >
                    Github
                  </Card.Link>
                ...
                <Card border="primary" style={{ width: "18rem" }}>
                  ...
                  <Card.Body>
                    ...
                    <Card.Text>
                      ...
                      restaurant suggestion result based on the user location.
                      Its goal is to streamline the restaurant decision-making
                      process by generating only one restaurant at random.
                    </Card.Text>
                    <Card.Link
              ...
              <div className="col-12 col-md-6 col-lg-4 m-2">
                ...
                >
                  ...
                  <Card.Body>
                    ...
                    <Card.Text>
                      This is a PWA made with MongoDB that allows users to be
                      able to log and track their withdrawals and deposits and
                      keep their balance accurate with or without a data or
                      internet connection.
                    </Card.Text>
                    <Card.Link
